...
$conn = new mysqli("localhost", "root", "stunt5800.", "foofkart");
	...
	$query="SELECT p_id,p_name,p_description,p_image_id,p_price,p_location,p_user FROM products where p_id<=".$till." and p_available=1 ";
